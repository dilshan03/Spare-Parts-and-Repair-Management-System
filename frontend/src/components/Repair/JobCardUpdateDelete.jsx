  ...
  return (
    <div className="container mt-4">
      ...
      <div className="card mb-4">
        <div className="card-header" style={{backgroundColor: "rgb(101, 16, 2)", color: "white"}}>
          <h4>
      ...
      <div className="card">
        <div className="card-header d-flex justify-content-between align-items-center" style={{backgroundColor: "rgb(101, 16, 2)", color: "white"}}>
          <h4>{jobCard.assignedMechanic?.firstName || "N/A"} {jobCard.assignedMechanic?.lastName || ""} Mechanic Jobs</h4>
